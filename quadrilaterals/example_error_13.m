...
set(gca,'YTick',[-16:1:-8]);
axis([pi/2 3*pi/2 -16 -11])
grid(gca,'minor')
grid on
...
print -depsc fig_quad_err_thet2
...
ax.MinorGridAlpha=0.75;
set(gca,'LooseInset',get(gca,'TightInset'))
print -depsc fig_quad_time_thet2
% print -dpdf fig_BC_E2c_err
%%
figure
